...
u_r_int = sp.simplify(u_r_int)

du_theta_dt = r * eps_tt - u_r_int
u_theta_int = sp.integrate(du_theta_dt, theta)
u_theta_int = sp.simplify(u_theta_int)

print("Exact integrated u_r:")
print(sp.expand(u_r_int))
print("\nExact integrated u_theta:")
print(sp.expand(u_theta_int))

u_r_a = sp.simplify(u_r_int.subs(r, a))
u_theta_a = sp.simplify(u_theta_int.subs(r, a))

print("\nAt r=a:")
print("u_r(a) =", sp.expand(u_r_a))
